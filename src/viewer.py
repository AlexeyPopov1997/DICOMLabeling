...
class Viewer(QLabel):
    ...
    def __init__(self, parent):
        ...
        self.colorTable = {Label.HEAD: Qt.blue,
                           Label.NECK: Qt.yellow,
                           Label.CHEST: Qt.darkMagenta,
                           Label.ABDOMEN: Qt.red,
                           Label.PELVIS: Qt.green}
        ...
        if selectedIdx >= 0:
            ...
            if action is not None:
                if action.text() == AppString.DELETE.value:
                    ...
                    selectedBox.setPalette(self.__set_bounding_box_color(Label(action.text())))
    ...
    def __initialize_mouse_line(self):
        ...
        for mouseLine in self.__mouseLines:
            ...
            mouseLine.setPalette(self.__set_bounding_box_color(Label.NECK))
            mouseLine.show()
